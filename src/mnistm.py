...
From https://github.com/Daipuwei/DANN-MNIST-tf2
...
class MNISTM(data.Dataset):
    ...
    def __init__(self,
        ...
        if self.train:
            self.train_data, self.train_labels = \
                torch.load(os.path.join(self.root, self.__class__.__name__,
    ...
    def download(self):
        ...
        # make data dirs
        try:
            os.makedirs(os.path.join(self.root, self.__class__.__name__, self.raw_folder))
            os.makedirs(os.path.join(self.root, self.__class__.__name__, self.processed_folder))
        except OSError as e:
        ...
        file_path = os.path.join(self.root, self.__class__.__name__, self.raw_folder, filename)
        ...
        with open(os.path.join(self.root, self.__class__.__name__,
                               self.processed_folder,
